...
- (instancetype)initWithASN1Data:(NSData*)asn1Data
{
    if (self = [super init])
    {
        ...
        [self.class enumerateASN1Attributes:(const uint8_t*)asn1Data.bytes length:asn1Data.length usingBlock:^(NSData *data, int type) {
            ...
            switch (type)
            {
                ...
                case RMAppReceiptASN1TypeExpirationDate:
                {
                    ...
                    _expirationDate = [self.class formatRFC3339String:string];
                    break;
                }
            }
        }];
...
+ (instancetype)bundleReceipt
{
    ...
    RMAppReceipt *receipt = [[self alloc] initWithASN1Data:data];
    return receipt;
}
